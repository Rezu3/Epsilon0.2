const questions = [
    {
        id: 1,
        question: `ভেক্টর $\\vec{P} = 6\\hat{i} + 4\\sqrt{2}\\hat{j} + 4\\sqrt{2}\\hat{k}$-এর Z-অক্ষের সাথে উৎপন্ন কোণ হলো—`,
        image: null,
        options: [
    ...
    {
        id: 6,
        question: `প্রাসের একটি নির্দিষ্ট নিক্ষেপ কোণের জন্য, যদি প্রাথমিক বেগ দ্বিগুণ করা হয়, তবে প্রাসের পাল্লা ($R$) কত গুণ হবে?`,
        image: null,
        options: [
            `অর্ধেক`,
            `এক-চতুর্থাংশ`,
    ...
    {
        id: 8,
        question: `এক ব্যক্তি একই দ্রুতি $u$ নিয়ে সব দিকে প্রচুর সংখ্যক গুলি ছোঁড়েন। মাটিতে সর্বাধিক যে ক্ষেত্রফল জুড়ে এই গুলিগুলো ছড়িয়ে পড়বে তা হলো—`,
        image: null,
        options: [
            `$$\\frac{\\pi u^2}{g}$$`,
            `$$\\frac{u^2}{g^2}$$`,
    ...
    {
        id: 12,
        question: `একটি কণার $v-t$ গ্রাফ চিত্রে দেখানো হয়েছে। প্রথম $4$ সেকেন্ডে কণাটির অতিক্রান্ত দূরত্ব কত?`,
        image: `12.png`,
        options: [
            `$$12\\text{ m}$$`,
            `$$16\\text{ m}$$`,
    ...
    {
        id: 14,
        question: `ভূমি থেকে একটি বস্তুকে খাড়া ওপরের দিকে নিক্ষেপ করা হলো। এটি $5\\text{ s}$ সময়ে সর্বোচ্চ উচ্চতায় পৌঁছায়। সর্বোচ্চ উচ্চতায় পৌঁছানোর পর তা ভূমিতে ফিরে আসতে কত সময় নেবে?`,
        image: null,
        options: [
            `$$2.5\\text{ s}$$`,
            `$$5\\text{ s}$$`,
    ...
    {
        id: 17,
        question: `চিত্রে একটি বস্তুর বেগ-সময় ($v-t$) লেখচিত্র দেওয়া আছে। $\\text{m}\\cdot\\text{s}^{-2}$ এককে বস্তুটির সর্বাধিক ত্বরণ কত?`,
        image: `17.png`,
        options: [
            `$$4$$`,
            `$$3$$`,
    ...
    {
        id: 18,
        question: `উক্ত বেগ-সময় লেখচিত্রে $t = 40\\text{ s}$ থেকে $t = 70\\text{ s}$ সময় ব্যবধানে কণাটির মন্দনের মান কত ($\\text{m}\\cdot\\text{s}^{-2}$ এককে)?`,
        image: `18.png`,
        options: [
            `$$2$$`,
            `$$1.33$$`,
